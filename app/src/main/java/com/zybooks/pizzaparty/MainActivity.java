...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculateClick(View view) {
        ...
        int checkedPizzaSizeId = mPizzaSizeRadioGroup.getCheckedRadioButtonId();
        PizzaCalculator.PizzaSize pizzaSize = PizzaCalculator.PizzaSize.LARGE;
        if (checkedPizzaSizeId == R.id.mediumSize_radio_button) {
            pizzaSize = PizzaCalculator.PizzaSize.MEDIUM;
        }
        else if (checkedPizzaSizeId == R.id.smallSize_radio_button) {
